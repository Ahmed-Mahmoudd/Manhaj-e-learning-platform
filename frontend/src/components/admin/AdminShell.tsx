...
const NAV: { to: string; labelKey: MessageKey; end?: boolean }[] = [
  { to: '/admin/faculties', labelKey: 'navFaculties', end: true },
  { to: '/admin/departments', labelKey: 'navDepartments' },
  { to: '/admin/terms', labelKey: 'navTerms' },
  { to: '/admin/courses', labelKey: 'navCourses' },
  { to: '/admin/sections', labelKey: 'navSections' },
      ...
      <header className="bg-ink text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
          <div className="flex items-center gap-4">
            <NavLink to="/admin/faculties" className="font-semibold tracking-widest text-white">
              MANHAJ
            </NavLink>
            <span className="hidden text-xs text-white/40 sm:inline">{t('adminConsole')}</span>
            {user && (
